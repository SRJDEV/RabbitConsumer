...
public class Contact implements Serializable {
    ...
    public Contact(BigInteger custID, Name name, Address address, String daytimePhoneNbr, String homePhoneNbr, String alternatePhoneNbr, boolean sendSMSMessage, String emailAddress, int separatorContact0) {
        this.custID = custID;
        this.name = name;
